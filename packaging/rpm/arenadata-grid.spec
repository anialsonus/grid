...
Version:          2.7.0
Release:          1
Summary:          Arenadata Grid In-Memory Computing, Database and Caching Platform
...
BuildArch:        noarch
%description
Arenadata Grid is a memory-centric distributed database, caching, and processing
...
%setup -q -n apache-ignite-2.7.0-bin
...
echoUpgradeMessage () {
    echo "======================================================================================================="
    echo "  WARNING: Updating Arenadata Grid's cluster version requires updating every node before starting grid  "
    echo "======================================================================================================="
}
...
cp -f %{buildroot}%{_datadir}/%{name}/bin/ignitevisorcmd.sh %{buildroot}%{_datadir}/doc/%{name}-%{version}/bin/
...
cp -rf %{_sourcedir}/arenadata-grid.sh %{buildroot}%{_sysconfdir}/profile.d/arenadata-grid.sh
